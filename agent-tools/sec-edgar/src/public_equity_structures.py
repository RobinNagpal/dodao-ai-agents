...
class MetricItemDefinition(BaseModel):
    key: str = Field(description="Unique identifier for the metric, formatted in lower case with underscores.")
    name: str = Field(description="Descriptive name of the metric.")
    description: str = Field(description="Detailed explanation of what the metric measures.")
    formula: str = Field(description="Mathematical formula used to calculate the metric (e.g., 'occupied_units / total_units').")

# Renamed to align with TS "CriterionReportDefinition"
class CriterionReportDefinition(BaseModel):
    key: str = Field(description="Unique identifier for the report associated with the criteria.")
    name: str = Field(description="Name of the report.")
    description: str = Field(description="Comprehensive description outlining the content and purpose of the report.")
...
class CriterionDefinition(BaseModel):
    key: str = Field(description="Unique identifier for the criteria, formatted in lower case with underscores.")
    name: str = Field(description="Descriptive name of the criteria.")
    shortDescription: str = Field(description="Brief overview of the criteria and its intended evaluation purpose.")
